...
# === 신경망에 필요한 모듈 ===
import torch
import torch.nn as nn  # 네트워크 구성 모듈
import torch.optim as optim  # optimization 모듈
from torch.utils.data import DataLoader  # 데이터셋 받을 때 사용되는 모듈
